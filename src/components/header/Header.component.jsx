        ...
        <div className="md:flex md:m-auto md:justify-between md:w-[1280px] md:h-16 bg-[#fff]">
            ...
            <div className="flex md:mt-0 mt-3">
                ...
                <div className="md:mt-3 md:w-24 w-24 cursor-pointer">
                    <div className="flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-cart2 md:w-[19px] md:h-[19px] w-[24px] h-[24px] mt-2 md:mt-0" viewBox="0 0 16 16">
                ...
                <div className="md:mt-3 md:w-24 w-20">
                    {
                        !user ?  <div>
                            <div className="flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-person md:w-[19px] md:h-[19px] w-[24px] h-[24px] mt-2 md:mt-0" viewBox="0 0 16 16">
                    ...
                    <div className="relative text-center md:block cursor-pointer account">
                        ...
                        <div className="absolute capitalize bg-slate-300 max-w-[200px] w-full top-[33px] hidden menu-account">
                            <Link className="py-[5px] px-[20px] hover:bg-PK-client block" to="/register">register</Link>
                            <Link className="py-[5px] px-[20px] hover:bg-PK-client block" to="/login">login</Link>
                        </div>
                    </div> 
