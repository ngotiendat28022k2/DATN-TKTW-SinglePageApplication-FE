        ...
        <div className="md:flex md:m-auto md:w-[1280px] bg-PK-client md:bg-[#fff] justify-between w-[100%] md:py-[20px]">
            ...
            <div className="flex justify-start items-center md:justify-start md:items-center px-[20px] md:px-0 pb-[20px] md:pb-0 md:w-[80%]">
                <div className="relative dropdown w-[12%] md:w-auto md:pr-[10px]">
                    <div className="flex md:mt-3 float-left md:float-none md:pr-0">
                        <div className="flex ">
                            <div>
                                <img
                    ...
                    <div className="absolute w-[410px] md:w-auto z-10 md:top-[40px] top-[50px] left-[-20px] md:left-[-256px] dropdown-menu hidden pt-[20px]">
                        <ClientMenu />
                    </div>
                </div>
                            ...
                            <div className="test-1 flex border-2 rounded-xl ">
                                ...
                                {onSearch.dataSearch || onSearch.historySearch ? (
                                    <div
                                        ...
                                        className="absolute overlay z-10 hidden md:block"
                                    ></div>
                                ) : null}
                        ...
                        {!user ? (
                            <div className="w-[50px] md:w-[80px]">
                                ...
                                <div
                                    ...
                                    ref={accountRef}
                                >
                                    <span className="hidden md:block h-[25px]" onClick={handleAccountClick}>Tài khoản</span>
                                    {showAccountMenu && (
                                        <div className="absolute capitalize bg-neutral-50 top-[25px] right-[0px] hidden menu-account rounded-[5px] shadow-2xl z-[1]">
