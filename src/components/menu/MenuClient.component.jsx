...
const ClientMenu = () => {
    ...
    const [showSchoolSupplierSubMenu, setshowSchoolSupplierSubMenu] =
        useState(false);
    return (
        <div className="z-10">
                ...
                <div className="md:mt-4 md:w-[25%] w-[40%]">
                    <div className="font-bold md:text-2xl md:text-gray-500 md:text-left md:mr-0  mb-4 flex md:ml-9 ml-6 md:w-[90%] w-[230%] text-lg text-center justify-between">
                        ...
                        <svg
                            ...
                            fill="currentColor"
                            className="bi bi-x-lg md:hidden block m-0 w-7 h-7 pl-2"
                            viewBox="0 0 16 16"
                        >
                    ...
                    <ul className="md:px-6 pr-0 pl-6 md:mb-10">
                        <li className="md:py-3 py-2 hover:bg-gray-200 rounded-xl">
                            <span
                                className="md:text-lg text-base md:px-3 px-0 text-[#212121] font-medium  hover:no-underline hover:text-black"
                                onMouseEnter={() => {
                        ...
                        <li
                            className="md:py-3 py-2 hover:bg-gray-200 rounded-xl"
                            onMouseEnter={() => {
