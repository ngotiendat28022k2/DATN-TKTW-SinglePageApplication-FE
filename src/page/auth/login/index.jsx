    ...
    const handleSubmit = async (event) => {
        ...
        try {
            if (!emailRegex.test(user.email)) {
                hepler.toast("error", "Invalid email");
                return;
            }
            const { payload } = await dispatch(login(user));
            console.log("payload", payload);
            ...
            <div className="py-6">
                <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "url(https://thumbs.dreamstime.com/b/old-book-flying-letters-magic-light-background-bookshelf-library-ancient-books-as-symbol-knowledge-history-218640948.jpg)",
                    ...
                    >
                        ...
                        <div className="mt-4 relative">
                            ...
                            <div className="absolute right-[10px] top-[50%]">
                                {showPassWord ? (
                                    <i
                                        className="fa-solid fa-eye text-gray-700"
                                        onClick={() => {
                                    ...
                                    <i
                                        className="fa-solid fa-eye-slash text-gray-700"
                                        onClick={() => {
