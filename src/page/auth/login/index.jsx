...
const Login = () => {
    const [checkedEyes, setCheckedEyes] = useState(false)
       ...
       <div className="w-full h-[100vh] relative">
        <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-w-[800px] w-full flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                <div className="w-full p-8 lg:w-1/2">
                    ...
                    <p className="text-xl text-gray-600 text-center">Welcome to NIKI!</p>
                    <div onClick={signInWithGoogle} className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100 cursor-pointer">
                    ...
                    <div className="mt-4">
                        ...
                        <div className='relative'>
                            <input 
                                ...
                                type={checkedEyes ? "text" : "password"}
                            />
                        <div className='absolute top-[25%] right-[10px]'>
                            {checkedEyes ? <i onClick={() => setCheckedEyes(false)} class="fa-regular fa-eye-slash"></i> : <i onClick={() => setCheckedEyes(true)} class="fa-regular fa-eye"></i>}
                        </div>
                        </div>
