...
import { getAllProductSeries } from "../../../slice/productseries";
...
export default function ProductList() {
    ...
    const series = useSelector((state) => state.productSeries.value);
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                const series = await dispatch(getAllProductSeries());
                setOptionSeries(
                    series.payload.data.map((a) => ({
                        ...a,
                        label: a.name,
                        value: a.name,
                    }))
